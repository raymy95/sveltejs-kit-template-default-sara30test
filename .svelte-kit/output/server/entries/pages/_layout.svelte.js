import { C as getContext, D as attr, E as attr_class, F as store_get, G as escape_html, I as unsubscribe_stores, B as pop, z as push } from "../../chunks/index3.js";
...
function Header($$payload, $$props) {
  ...
  var $$store_subs;
  let menuOpen = false;
  $$payload.out += `<header class="svelte-fs1l5j"><div class="corner svelte-fs1l5j"><a href="https://svelte.dev/docs/kit" class="svelte-fs1l5j"><img${attr("src", logo)} alt="SvelteKit" class="svelte-fs1l5j"></a></div> <button class="menu-button svelte-fs1l5j" aria-label="Toggle menu"><div${attr_class("hamburger svelte-fs1l5j", void 0, { "open": menuOpen })}><span class="svelte-fs1l5j"></span> <span class="svelte-fs1l5j"></span> <span class="svelte-fs1l5j"></span></div></button> <nav${attr_class("svelte-fs1l5j", void 0, { "open": menuOpen })}><svg viewBox="0 0 2 3" aria-hidden="true" class="nav-arrow svelte-fs1l5j"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-fs1l5j"></path></svg> <ul class="svelte-fs1l5j"><li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/" ? "page" : void 0)} class="svelte-fs1l5j"><button class="svelte-fs1l5j">Home</button></li> <li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/about" ? "page" : void 0)} class="svelte-fs1l5j"><button class="svelte-fs1l5j">About</button></li> <li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/collection" ? "page" : void 0)} class="svelte-fs1l5j"><button class="svelte-fs1l5j">Collection</button></li> <li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/score" ? "page" : void 0)} class="svelte-fs1l5j"><button class="svelte-fs1l5j">Classement</button></li> `;
  if (store_get($$store_subs ??= {}, "$auth", auth).username) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<li class="username svelte-fs1l5j"><span>Welcome, ${escape_html(store_get($$store_subs ??= {}, "$auth", auth).username)}!</span></li> <li class="svelte-fs1l5j"><button class="logout-button svelte-fs1l5j">Logout</button></li>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></ul> <svg viewBox="0 0 2 3" aria-hidden="true" class="nav-arrow svelte-fs1l5j"><path d="M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z" class="svelte-fs1l5j"></path></svg></nav> <div class="corner svelte-fs1l5j"><a href="https://github.com/sveltejs/kit" class="svelte-fs1l5j"><img${attr("src", github)} alt="GitHub" class="svelte-fs1l5j"></a></div></header>`;
...
function _layout($$payload, $$props) {
  ...
  var $$store_subs;
  let { children } = $$props;
  $$payload.out += `<div class="app svelte-12xrmuh">`;
  if (store_get($$store_subs ??= {}, "$page", page).url.pathname !== "/error") {
    $$payload.out += "<!--[-->";
    Header($$payload);
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <main class="svelte-12xrmuh">`;
  children($$payload);
  $$payload.out += `<!----></main> <footer class="svelte-12xrmuh"><p>visit <a href="https://svelte.dev/docs/kit" class="svelte-12xrmuh">svelte.dev/docs/kit</a> to learn about SvelteKit</p></footer></div>`;
  if ($$store_subs) unsubscribe_stores($$store_subs);
  pop();
}
export {
