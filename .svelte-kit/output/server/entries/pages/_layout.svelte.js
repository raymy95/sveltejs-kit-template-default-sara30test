import { C as attr, B as pop, z as push, D as store_get, E as unsubscribe_stores } from "../../chunks/index2.js";
...
function Header($$payload, $$props) {
  push();
  $$payload.out += `<header class="svelte-1ywpxxv"><div class="corner svelte-1ywpxxv"><a href="https://svelte.dev/docs/kit" class="svelte-1ywpxxv"><img${attr("src", logo)} alt="SvelteKit" class="svelte-1ywpxxv"></a></div> <nav class="svelte-1ywpxxv"><svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1ywpxxv"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-1ywpxxv"></path></svg> <ul class="svelte-1ywpxxv"><li${attr("aria-current", page.url.pathname === "/" ? "page" : void 0)} class="svelte-1ywpxxv"><a href="/" class="svelte-1ywpxxv">Home</a></li> <li${attr("aria-current", page.url.pathname === "/about" ? "page" : void 0)} class="svelte-1ywpxxv"><a href="/about" class="svelte-1ywpxxv">About</a></li> <li${attr("aria-current", page.url.pathname === "/collection" ? "page" : void 0)} class="svelte-1ywpxxv"><a href="/collection" class="svelte-1ywpxxv">Collection</a></li> <li${attr("aria-current", page.url.pathname === "/score" ? "page" : void 0)} class="svelte-1ywpxxv"><a href="/score" class="svelte-1ywpxxv">Classement</a></li> <li class="svelte-1ywpxxv"><button class="logout-button svelte-1ywpxxv">Logout</button></li></ul> <svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1ywpxxv"><path d="M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z" class="svelte-1ywpxxv"></path></svg></nav> <div class="corner svelte-1ywpxxv"><a href="https://github.com/sveltejs/kit" class="svelte-1ywpxxv"><img${attr("src", github)} alt="GitHub" class="svelte-1ywpxxv"></a></div></header>`;
  pop();
}
function _layout($$payload, $$props) {
  ...
  var $$store_subs;
  let { children } = $$props;
  store_get($$store_subs ??= {}, "$page", page$1).url.pathname !== "/login" && !store_get($$store_subs ??= {}, "$auth", auth);
  $$payload.out += `<div class="app svelte-12xrmuh">`;
  if (store_get($$store_subs ??= {}, "$auth", auth) || store_get($$store_subs ??= {}, "$page", page$1).url.pathname === "/login") {
    $$payload.out += "<!--[-->";
    ...
    children($$payload);
    $$payload.out += `<!----></main> <footer class="svelte-12xrmuh"><p>visit <a href="https://svelte.dev/docs/kit" class="svelte-12xrmuh">svelte.dev/docs/kit</a> to learn about SvelteKit</p></footer>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
